...
// // backend/routes/receiptTemplates.js
...
//   sampleTripReceipt,
//   churchInfo,
// } = require("../../frontend/src/components/receipts/receiptSampleData");
...
//   const v = clean(value, "other").toLowerCase();
...
//   if (["school", "kids", "kids_school"].includes(v)) {
//     return "school";
//   }
...
//   const v = clean(value, "general_donation")
//     .toLowerCase()
//     .replace(/\s+/g, "_");
...
//   return {
//     value: v,
//     label: labels[v] || pretty(v),
//   };
// }

// function buildCoverageMonths(start, end) {
//   if (!start || !end) return [];
...
//     return `${formatDate(row.coverage_start)} → ${formatDate(
//       row.coverage_end
//     )}`;
//   }

//   if (row.period_start && row.period_end) {
//     return `${formatDate(row.period_start)} → ${formatDate(
//       row.period_end
//     )}`;
//   }
...
// function buildCardLabel(row) {
//   if (!row.card_brand || !row.card_last4) {
//     return "--";
//   }

//   return `${String(row.card_brand).toUpperCase()} •••• ${
//     row.card_last4
//   }`;
// }
...
//   const coverageLabel = buildCoverageLabel(row);
...
//       months_paid:
//         Number(row.months_paid || 1),
//     },
//   ];
// }

// function donationRows(row) {
...
//       remark: donationCategory.label,

//       donation_category:
//         donationCategory.label,
//     },
//   ];
// }

// function schoolRows(row) {
//   return [
//     {
//       code: "21",
...
//   if (category === "membership") {
//     rows = membershipRows(row);
//   }

//   if (category === "donation") {
//     rows = donationRows(row);
//   }
