//frontend\src\components\modals\VolunteerHoursPopup.jsx
...
export default function VolunteerHoursPopup({ open, onClose }) {
    ...
    <div className="asc-modal-backdrop" onClick={onClose}>
      <div className="asc-modal asc-modal--post" onClick={(e) => e.stopPropagation()}>
        <div className="asc-modal-header">
          <div>
            <p className="asc-eyebrow">Holy Trinity Ethiopian Orthodox Church</p>
          ...
          <form className="vap-card" onSubmit={handleSubmit}>
            ...
            <div className="vap-grid">
              ...
              <label>
                ...
                <input
                  type="text"
                  value={form.total_hours || hoursPreview}
                  readOnly
