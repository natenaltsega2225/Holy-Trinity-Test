//frontend\src\pages\VolunteerHoursPage.jsx
...
export default function VolunteerHoursPage() {
  ...
  async function handleSubmit(e) {
    ...
    if (!form.start_time || !form.end_time) {
      setAlert({ type: "error", text: "Start time and end time are required." });
      return;
    }
    ...
    <div className="vap-page">
      <div className="vap-shell">
        <div className="vap-hero">
          ...
          <h1 className="vap-title">Log My Volunteer Hours</h1>
          <p className="vap-subtitle">
            Submit the hours you served so the church can maintain an accurate
            service record, volunteer summary, and recognition history.
          </p>
        </div>
        ...
        <div className="vap-card vap-card--context">
          <div className="vap-context-grid">
            ...
            <div className="vap-context-item">
              ...
              <strong>Hours contribute to recognition levels</strong>
            </div>
